...
public class PatientViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("id") == null) {
			RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/myPatients");
		...
		RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/views/myPatientView.jsp");
		dispatcher.forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ((request.getParameter("diagnosis") == null || request.getParameter("diagnosis").equals("Unknown")
				|| request.getParameter("diagnosis").equals("")) && request.getParameter("type").equals("dishcharge")) {
